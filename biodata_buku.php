...
if (isset($_GET['idb'])) {
    ...
    if ($data) {
        ...
        echo "<a href='pusaka.php?page=b_pinjam&idb={$id}' class='btn btn-sm btn-primary btn_margin'>Pinjam</a>";
        echo "<a href='pusaka.php?page=home' class='btn btn-sm btn-primary btn_margin'>Kembali</a>";
        echo '</div>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
